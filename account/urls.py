...
urlpatterns = [
    ...
    url(r'^login/$', auth_views.login, name='user_login'),   #django内置的登录,user_login别名是为认前端HTML调用
    url(r'^new_login/$', auth_views.login, {"template_name": "account/login.html"}),  #不需要重定向，直接指定HTML
    ...
    url(r'^password-change-done/$', auth_views.password_change_done, name='password_change_done'),  #改密码完成页面
